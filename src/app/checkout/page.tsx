...
//   return (
//     <div className="min-h-screen bg-white max-w-7xl mx-auto px-4 py-8">
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
//         {/* Order Summary */}
...
//           {cartItems.map((item, index) => (
//             <div key={item.id || index} className="flex items-center gap-4 py-3 border-b">
//               <Image src={item.imageUrl} alt={item.name} width={64} height={64} className="object-cover w-16 h-16" />
//               <div className="flex-1">
//                 <h3 className="text-lg font-bold">{item.name}</h3>
//                 <p className="text-sm text-gray-600">Size: {item.size} | Color: {item.color} | Qty: {item.quantity}</p>
//               </div>
...
//           <div className="py-3 text-sm border-t mt-4">
//             <div className="flex justify-between py-2"><span>Subtotal:</span><span>${subtotal.toFixed(2)}</span></div>
//             <div className="flex justify-between py-2 text-red-600"><span>Discount:</span><span>-${discount.toFixed(2)}</span></div>
//             <div className="flex justify-between py-2 font-bold"><span>Total:</span><span>${total.toFixed(2)}</span></div>
//           </div>

//           <button
//             onClick={handlePlaceOrder}
//             className="w-full h-12 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-sm mt-4 text-lg"
//           >
//             Place Order
//           </button>
//         </div>
